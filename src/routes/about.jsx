  ...
  return (
    <div id="about-page">
      ...
      <div className="space-y-8 my-8 md:w-[60%] mx-auto">
        ...
        <img className="md:border md:p-3" src={PersonalImage} />
        ...
        <div className="about-contact-btn space-y-8 my-8">
          <img className="md:border md:p-3" src={InquireImage} />
